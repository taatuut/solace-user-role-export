...
📄 CSV   → ./output/solace_users_roles_20260630_140736.csv  (157 rows)
📊 Excel → ./output/solace_users_roles_20260630_140736.xlsx  (157 users, 3 sheets)
🗂️  JSON  → ./output/solace_users_roles_20260630_140736.json  (157 records)

✅ Export complete!
   Files written to: /path/to/output/
```
...
|------|--------|--------------|
| `solace_users_roles_<TIMESTAMP>.csv` | CSV | All users with roles, UTF-8-SIG encoded |
| `solace_users_roles_<TIMESTAMP>.xlsx` | Excel | Multi-sheet: All Users, Admins, Role Summary |
| `solace_users_roles_<TIMESTAMP>.json` | JSON | Structured export with metadata envelope |
